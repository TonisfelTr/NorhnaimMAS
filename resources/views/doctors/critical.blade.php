                        ...
                        <div class="lab-attention-list">
                            @foreach($criticalResults as $item)
                                ...
                                <article class="lab-attention-card lab-attention-card--critical">
                                    ...
                                    @if(($item->deviation_results_count ?? 0) > 0)
                                        <div class="lab-note mt-3">
                                            Критических показателей:
                                            <strong>
                                                {{ $item->critical_results_count ?? 0 }}
                                            </strong>

                                            · Других отклонений:
                                            <strong>
                                                {{ $item->deviation_results_count }}
                                            </strong>
                                        </div>
                                    @elseif(($item->critical_results_count ?? 0) > 1)
                                        <div class="lab-note mt-3">
                                            Критических показателей:
                                            <strong>
